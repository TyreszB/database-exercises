...
VALUES ('Micheal Jackson','Thriller',1982,51.2,'Pop'),
('AC/DC','Back in Black',1980,30.1,'Hard Rock'),
('Whitney Huston','The Bodyguard',1992,28.7,'R&B'),
...
('Led Zeppelin','Led Zeppelin IV',1971,30.4,'Hark Rock'),
('Micheal Jackson','Bad',1987,21.2,'Pop'),
...
('The Beatles','Sgt. Peppers Lonely Hearts Club Band',1967,17,'Rock'),
